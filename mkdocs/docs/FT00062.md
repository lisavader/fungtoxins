...
<img data-smiles= CC(=O)O[C@H]1C[C@@]23COC(=O)C4O[C@@]45CCO/C(=C/C/C=C\C(=O)O[C@@H]4C[C@@H](O[C@@H]2C=C1C)C1(CO1)[C@]43C)[C@H]5O data-smiles-options="{ 'width': 350, 'height': 350 }" />
</div>
## Compound details
...
<div class="break_all">
SMILES: CC1=C[C@]2([H])[C@]3(COC(C4([H])[C@@]5(O4)C([H])([H])CO/C([C@]5(O)[H])=C([H])/C([H])([H])/C=C\C(O[C@H]6[C@@]3(C)C7([C@@](O2)([H])C6)CO7)=O)=O)C[C@@H]1OC(C)=O<br>
</div>
