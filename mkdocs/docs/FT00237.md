...
# FT00237: Ala-viroidin
<div class="molecule_image" style="float:left">
<img data-smiles= CC1NC(=O)C(CC(C)(O)CO)NC(=O)C(CC2=C(S(C)(=O)=O)NC3=C2C=CC=C3)NC(=O)C(C)NC(=O)C2C(O)C(O)CN2C(=O)C(CO)NC(=O)C(C(C)O)NC1=O data-smiles-options="{ 'width': 350, 'height': 350 }" />
</div>
## Compound details
<div style="overflow:hidden">
Name: Ala-viroidin<br>
Molecular formula: C36H52N8O15S<br>
Molecular mass (Da): 868.92<br>
Monoisotopic mass (Da): 868.3273<br>
<div class="break_all">
SMILES: CC1C(NC(Cc2c(S(=O)(C)=O)[nH]c3c2cccc3)C(NC(CC(CO)(O)C)C(NC(C)C(NC(C(O)C)C(NC(CO)C(N4CC(O)C(O)C4C(N1)=O)=O)=O)=O)=O)=O)=O<br>
</div>
